const Skills = {
  FrontEnd: {
    ...
    vite: {
      name: "Vite",
      icon: "https://github.com/marwin1991/profile-technology-icons/assets/62091613/b40892ef-efb8-4b0e-a6b5-d1cfc2f3fc35",
    },
    babel: {
      name: "Babel",
      icon: "https://github.com/marwin1991/profile-technology-icons/assets/136815194/ecd443af-ebba-4af8-a46e-1bf64d863b5b",
    },
    webpack: {
      name: "Webpack",
  ...
  BackEnd: {
    ...
    rest: {
      name: "REST API",
      icon: "https://user-images.githubusercontent.com/25181517/192107858-fe19f043-c502-4009-8c47-476fc89718ad.png",
    },
    graph: {
      name: "GraphQL",
      icon: "https://user-images.githubusercontent.com/25181517/192107856-aa92c8b1-b615-47c3-9141-ed0d29a90239.png",
    },
    websocket: {
      name: "WebSockets",
      icon: "https://user-images.githubusercontent.com/25181517/187070862-03888f18-2e63-4332-95fb-3ba4f2708e59.png",
  ...
  DevOps: {
    cicd: {
      name: "CI/CD",
      icon: "https://user-images.githubusercontent.com/25181517/183868728-b2e11072-00a5-47e2-8a4e-4ebbb2b8c554.png",
    },
    docker: {
      name: "Docker",
    ...
    nginx: {
      name: "Nginx",
      icon: "https://user-images.githubusercontent.com/25181517/183345125-9a7cd2e6-6ad6-436f-8490-44c903bef84c.png",
    },
    k8: {
      name: "Kubernetes",
